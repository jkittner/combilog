...
def test_authenticate_wrong_password():
    my_logger = Combilog(logger_addr=1, port='com3')
    auth = my_logger.authenticate(passwd='wrong_password')
    assert auth is False


def test_authenticate_successfull():
    my_logger = Combilog(logger_addr=1, port='com3')
    auth = my_logger.authenticate(passwd='12345678')
    assert auth is True


def test_get_channel_info_not_found():
    my_logger = Combilog(logger_addr=1, port='com3')
...
def test_reset_channel_success():
    my_logger = Combilog(logger_addr=1, port='com3')
    my_logger.authenticate('12345678')
...
def test_read_event_invalid_pointer():
    my_logger = Combilog(logger_addr=1, port='com3')
    my_logger.authenticate('12345678')
    invalid_pointer = '5'
    with pytest.raises(ValueError) as execinfo:
...
@pytest.mark.parametrize('pointer', ('1', 2))
def test_repeat_read_event(pointer):
    my_logger = Combilog(logger_addr=1, port='com3')
    my_logger.authenticate('12345678')
    my_logger.pointer_to_start(pointer)
...
def test_repeat_read_event_invalid_pointer():
    my_logger = Combilog(logger_addr=1, port='com3')
    my_logger.authenticate('12345678')
    invalid_pointer = '5'
    with pytest.raises(ValueError) as execinfo:
...
@pytest.mark.parametrize('pointer', ('1', 2))
def test_set_pointer_to_date_str(pointer):
    my_logger = Combilog(logger_addr=1, port='com3')
    my_logger.authenticate('12345678')
    # if not successfull it raises an error
...
def test_set_pointer_to_date_invalid_pointer():
    my_logger = Combilog(logger_addr=1, port='com3')
    my_logger.authenticate('12345678')
    invalid_pointer = '5'
    with pytest.raises(ValueError) as execinfo:
...
@pytest.mark.parametrize('pointer', ('1', 2))
def test_set_pointer_to_date_datetime(pointer):
    my_logger = Combilog(logger_addr=1, port='com3')
    my_logger.authenticate('12345678')
    date = datetime(
        year=2020,
...
@pytest.mark.parametrize('pointer', ('1', 2))
def test_set_pointer_to_date_invalid_str(pointer):
    my_logger = Combilog(logger_addr=1, port='com3')
    my_logger.authenticate('12345678')
    # if not successfull it raises an error
...
@pytest.mark.parametrize('pointer', ('1', 2))
def test_set_pointer_to_position(pointer):
    my_logger = Combilog(logger_addr=1, port='com3')
    my_logger.authenticate('12345678')
    # if not successfull it raises an error
    position = '123'
...
def test_set_pointer_to_position_invalid_pointer():
    my_logger = Combilog(logger_addr=1, port='com3')
    my_logger.authenticate('12345678')
    invalid_pointer = '5'
    position = '123'
...
def test_set_datetime_invalid_date():
    my_logger = Combilog(logger_addr=1, port='com3')
    my_logger.authenticate('12345678')
    # if not successfull it raises an error
...
def test_set_rate(measuring_rate, averaging_interval):
    my_logger = Combilog(logger_addr=1, port='com3')
    my_logger.authenticate('12345678')
    # get rate
    rates = my_logger.get_rate()
...
def test_set_rate_invalid_measuring_rate():
    my_logger = Combilog(logger_addr=1, port='com3')
    my_logger.authenticate('12345678')
    with pytest.raises(ValueError) as execinfo:
...
def test_set_rate_invalid_averaging_interval():
    my_logger = Combilog(logger_addr=1, port='com3')
    my_logger.authenticate('12345678')
    with pytest.raises(ValueError) as execinfo:
...
def test_read_logger_not_verbose_dict():
...
def test_read_logger_verbose_dict(capsys):
    # test will fail if no logs or only 1 are present
    my_logger = Combilog(logger_addr=1, port='com3')
    my_logger.authenticate('12345678')
    my_logger.pointer_to_start(pointer=1)
...
def test_read_logger_verbose_list(capsys):
    # test will fail if no logs or only 1 are present
    my_logger = Combilog(logger_addr=1, port='com3')
    my_logger.authenticate('12345678')
    my_logger.pointer_to_start(pointer=1)
...
def test_read_logger_wrong_output_type():
    my_logger = Combilog(logger_addr=1, port='com3')
    my_logger.authenticate('12345678')
    my_logger.pointer_to_start(pointer=1)
    with pytest.raises(ValueError) as execinfo:
...
def test_set_transparent_mode(state):
    my_logger = Combilog(logger_addr=1, port='com3')
    my_logger.authenticate('12345678')
